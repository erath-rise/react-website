        ...
        <div>
            ...
            <div className='grid lg:grid-cols-2 mt-20 gap-20'>
                <div>
                    ...
                    <p className='mt-4 mb-8 text-gray-500'>强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具</p>
                    <ul className='grid gap-3'>
                        {[1, 2, 3].map((v) => (
                            <li className={`p-5 justify-between rounded border border-zinc-100 ${v === 1 && "bg-zinc-100"}`}
                                key={v}
                            >
